...
4. `scripts/routing-points.json` defines the 10 municipality origins and all 11 current demo outlets; CI checks it against canonical app data.
...
8. The resilient SVG map remains available when the live map cannot load.
