...
Follow-up correction: comparison selections embedded in the URL now seed the server-rendered ledger, preventing a misleading empty-state flash before client hydration.
