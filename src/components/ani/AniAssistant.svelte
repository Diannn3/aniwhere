...
<style>
  ...
  .ani-status { min-height:2.3rem; display:flex; align-items:center; padding:.55rem 1rem; background:rgba(252,236,216,.5); border-bottom:1px solid rgba(32,37,30,.08); color:#5f3215; font-size:.76rem; font-weight:650; }
